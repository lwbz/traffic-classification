...
from ts_tfc_ssl.ts_utils import build_model, set_seed, build_dataset, get_all_datasets, \
    build_loss, evaluate_base

if __name__ == '__main__':

    parser = argparse.ArgumentParser()
    # Base setup
    parser.add_argument('--backbone', type=str, default='LSTM', help='MLP, LSTM')
    ...
    parser.add_argument('--num_classes', type=int, default=17, help='number of class')
    ...
    for i, train_dataset in enumerate(train_datasets):
        ...
        for epoch in range(1, args.warmup_epochs + 1):
            ...
            val_loss, val_accu_tem, _, _, _, _ = evaluate_base(val_loader, model, loss, device)
            ...
            test_loss, test_accuracy_tem, test_precision, test_recall, test_f1, conf_matrix = evaluate_base(test_loader,
                                                                                                            model, loss, device)
    ...
    new_name = new_name + "_" + str(args.labeled_ratio) + "_main_base"
